...
When you’re happy with your solution, send us a link to review it along with any notes or caveats you’d like to disclose. We'll want to compile your code from source and run it from a Unix-like command line, so please include the complete instructions for doing so in a COMMENTS file.
